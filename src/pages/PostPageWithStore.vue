<template>
  <div>
    ...
    <div class="m-4">
      ...
      <div>
        <i-button @click="$store.commit('incrementLikes')">+</i-button>
        <i-button @click="$store.commit('decrementLikes')">-</i-button>
      </div>
    </div>
    <div class="m-4 flex">
      <i-input
...
export default {
  components: {IButton, PostPaginate, PostList, PostForm},
  data() {
    return {
      posts: [],
      dialogVisible: false,
